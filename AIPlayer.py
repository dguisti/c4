...
class AIPlayer(Player):
    ...
    def __init__(self,designator,playerType,gb,D1,D2,D3,D4,computer=True):
        super().__init__(designator,playerType,gb,computer=True)
        self.name = "Kevin AI"
        #def __init__(self, state_space, action_space):
        self.exploration_rate = EXPLORATION_MAX
        self.action_space = 7 #the number of columns
        self.state_space = len([item for sublist in gb.getBoard() for item in sublist]) #columns * rows
        ...
        self.model.add(Dense(D1, activation="elu"))
        self.model.add(Dense(D2, activation="elu"))
...
which seems to be based on: https://github.com/keon/deep-q-learning
